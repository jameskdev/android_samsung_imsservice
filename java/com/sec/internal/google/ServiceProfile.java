...
public class ServiceProfile {
    ...
    public void notifyRegistrationFeatureCapabilityChanged(int svcClass, int[] enabledFeatures, int[] disabledFeatures) {
        int i = this.mRegistrationListener.beginBroadcast();
        while (i > 0) {
            i--;
            try {
                this.mRegistrationListener.getBroadcastItem(i).registrationFeatureCapabilityChanged(svcClass, enabledFeatures, disabledFeatures);
        ...
        this.mRegistrationListener.finishBroadcast();
    }
